...
module.exports.run = async (client, message, args) => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .setDescription(`\n[Click to View your Profile!](https://vcodez.xyz/user/${users.id})\n\n**Analytics**\n You own **${bots.length || "0"} Bots** and **${servers.length} Servers**`)
    .setColor("#7289da")
    .addField("Bots [" + bots.length + "]", `${!bots ? "" : bots.map(a => "<@" + a.botID + ">  **[**[View " + a.username + "](https://vcodez.xyz/bot/" + a.botID + ")**]**").join("\n")}\n\n **Servers [${servers.length}]** \n${!servers ? "" : servers.map(b => b.name + " **[**[View " + b.name + "](https://vcodez.xyz/server/" + b.id + ")**]**").join("\n")}`, true)
