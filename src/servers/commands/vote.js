...
exports.run = async (client, message, args) => {
    ...
    .setStyle("url")
    .setURL("https://vcodez.xyz/server/"+message.guild.id)
  ...
  .setImage('https://cdn.discordapp.com/attachments/860627883731320866/872486529518436462/Vcodez.xyz_3.png')
    ...
    .setImage('https://cdn.discordapp.com/attachments/860627883731320866/872486533679186020/Vcodez.xyz_2.png')
...
function msgError(msg, { channel }) {
    ...
    .setFooter('Vcodez.xyz/servers')
    .setImage('https://cdn.discordapp.com/attachments/860627883731320866/872486527219937300/Vcodez.xyz.gif')
    .setDescription(msg)
    .setColor("RED")
    )
}