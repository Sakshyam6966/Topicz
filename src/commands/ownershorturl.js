...
module.exports.run = async (client,message,args) => {
    if(!global.config.bot.owners.includes(message.author.id)) return  message.reply('<:no:833101993668771842> Only The Owner Of Vcodez Can Use This Bypass <:no:833101993668771842>')
